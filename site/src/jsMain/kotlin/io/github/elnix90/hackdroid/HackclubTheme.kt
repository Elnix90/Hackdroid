...
object SitePalettes {
    val light = SitePalette(
        // Light gray for near-background
        nearBackground = Color.rgb(0xf5f6f7),
        brand = SitePalette.Brand(
            primary = Color.rgb(0xEC3750),  // Hack Club Red
            accent = Color.rgb(0x338eda),    // Hack Club Blue
        )
    )
...
fun initHackClubTheme(ctx: InitSilkContext) {
    ...
    ctx.theme.palettes.light.background = Color.rgb(0xfafbfc)
    ctx.theme.palettes.light.color = Color.rgb(0x1c1b1f)
